...
<body>
	...
	String sql = "select * from product_animal where p_id = ? ";
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<h4><%=rs.getString("p_unitPrice")%>살</h4>
				<p><form name="addForm" action="./addCart_animal.jsp?id=<%=rs.getString("p_id")%>" method="post">
					...
					<a href="./cart_animal.jsp?id=animalCartId" class="btn btn-warning"> 장바구니 &raquo;</a> 
